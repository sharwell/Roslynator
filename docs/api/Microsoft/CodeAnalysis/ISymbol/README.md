...
| ---------------- | ------- |
| [GetAttribute(ISymbol, INamedTypeSymbol)](../../../Roslynator/SymbolExtensions/GetAttribute/README.md#_Top) | Returns the attribute for the symbol that matches the specified attribute class, or null if the symbol does not have the specified attribute\. |
...
| [IsAsyncMethod(ISymbol)](../../../Roslynator/SymbolExtensions/IsAsyncMethod/README.md#_Top) | Returns true if the symbol is an async method\. |
| [IsErrorType(ISymbol)](../../../Roslynator/SymbolExtensions/IsErrorType/README.md#_Top) | Returns true if the symbol represents an error\. |
...
| [IsPubliclyVisible(ISymbol)](../../../Roslynator/SymbolExtensions/IsPubliclyVisible/README.md#_Top) | Return true if the specified symbol is publicly visible\. |
