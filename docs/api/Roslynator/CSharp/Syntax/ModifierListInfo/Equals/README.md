...
| Method | Summary |
| ------ | ------- |
| Equals\(ModifierListInfo\) | Determines whether this instance is equal to another object of the same type\. \(Implements [IEquatable\<ModifierListInfo>.Equals](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1.equals)\) |
...
## Equals\(ModifierListInfo\)<a name="Roslynator_CSharp_Syntax_ModifierListInfo_Equals_System_Object_"></a>
