...
| Equals\(UsingDirectiveListInfo\) | Determines whether this instance is equal to another object of the same type\. \(Implements [IEquatable\<UsingDirectiveListInfo>.Equals](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1.equals)\) |
...
## Equals\(UsingDirectiveListInfo\)<a name="Roslynator_CSharp_Syntax_UsingDirectiveListInfo_Equals_System_Object_"></a>
