...
| Equals\(StatementListInfo\) | Determines whether this instance is equal to another object of the same type\. \(Implements [IEquatable\<StatementListInfo>.Equals](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1.equals)\) |
...
## Equals\(StatementListInfo\)<a name="Roslynator_CSharp_Syntax_StatementListInfo_Equals_System_Object_"></a>
