...
| Method | Summary |
| ------ | ------- |
| Equals\(IsExpressionInfo\) | Determines whether this instance is equal to another object of the same type\. \(Implements [IEquatable\<IsExpressionInfo>.Equals](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1.equals)\) |
...
## Equals\(IsExpressionInfo\)<a name="Roslynator_CSharp_Syntax_IsExpressionInfo_Equals_System_Object_"></a>
