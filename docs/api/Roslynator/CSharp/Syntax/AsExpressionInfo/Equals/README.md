...
| Method | Summary |
| ------ | ------- |
| Equals\(AsExpressionInfo\) | Determines whether this instance is equal to another object of the same type\. \(Implements [IEquatable\<AsExpressionInfo>.Equals](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1.equals)\) |
...
## Equals\(AsExpressionInfo\)<a name="Roslynator_CSharp_Syntax_AsExpressionInfo_Equals_System_Object_"></a>
