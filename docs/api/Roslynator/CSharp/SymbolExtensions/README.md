# SymbolExtensions Class <a name="_Top"></a>
...
| [SupportsConstantValue(ITypeSymbol)](SupportsConstantValue/README.md#_Top) | Returns true if the specified type can be used to declare constant value\. |
