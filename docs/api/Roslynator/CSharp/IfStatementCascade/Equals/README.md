...
| Method | Summary |
| ------ | ------- |
| Equals\(IfStatementCascade\) | Determines whether this instance is equal to another object of the same type\. \(Implements [IEquatable\<IfStatementCascade>.Equals](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1.equals)\) |
...
## Equals\(IfStatementCascade\)<a name="Roslynator_CSharp_IfStatementCascade_Equals_System_Object_"></a>
